    ...
    def get_prompt(self, perception: PerceptionResult) -> str:
        return format_prompt(
            ...
            [
                ...
                ("Retrieval queries", ", ".join(perception.topic.retrieval_queries)),
                ("Threat signal", perception.npc_perception.threat_signal),
                ("Manipulation signal", perception.npc_perception.manipulation_signal),
                ("Topic sensitivity", perception.npc_perception.topic_sensitivity),
