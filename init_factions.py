...
def create_faction(driver, faction_data):
    return driver.execute_query(
        """
        CREATE (f:Faction {id: $id, name: $name, form: $form, race: $race, political_power: $political_power, army_power: $army_power, cooperative_rating: $cooperative_rating, biological_properties: $biological_properties, nature: $nature, goal: $goal, habital_area: $habital_area, quantity: $quantity, strengths: $strengths, weakness: $weakness })
        RETURN f
        """,
        ...
        biological_properties=faction_data.get("biological_properties"),
        nature=faction_data.get("nature"),
        goal=faction_data.get("goal"),
        habital_area=faction_data.get("habital_area"),
        quantity=faction_data.get("quantity"),
        strengths=faction_data.get("strengths"),
        weakness=faction_data.get("weakness"),
    )
...
def init_factions():
    with GraphDatabase.driver(uri, auth=auth) as driver:
        ...
        with open('./data/faction_data.csv', mode ='r') as file:    
